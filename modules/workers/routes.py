...
from .service import (create_or_update_profile, get_profile ,add_skill_to_worker,
...
def save_profile():
    ...
    response, status = create_or_update_profile(user_id, data)
...
def add_skill():
    ...
    response, status = add_skill_to_worker(user_id, data["skill"])
...
def remove_skill():
    ...
    response, status = remove_skill_from_worker(user_id, data["skill"])
...
def availability():
    ...
    response, status = set_availability(user_id, data)
